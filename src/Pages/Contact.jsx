            ...
            <div className="flex items-center justify-center h-[100vh]">
                <form noValidate onSubmit={onFormSubmit} className="flex flex-col items-center justify-center gap-2 p-5 rounded-md text-black shadow-[0_0_10px_black] w-[22rem]">
                    ...
                    <div className="flex flex-col w-full gap-1">
                        ...
                        <input
                            className="bg-transparent border border-gray-600 px-2 py-1 rounded-sm"
                            id="name"
                            type="text"
                            name="name"
                    ...
                    <div className="flex flex-col w-full gap-1">
                        ...
                        <textarea
                            className="bg-transparent border border-gray-600 px-2 py-1 rounded-sm resize-none h-40"
                            id="message"
                            name="message"
                    ...
                    <button
                        className="w-full bg-yellow-600 transition-all ease-in-out duration-300 rounded-sm py-2 text-lg font-bold cursor-pointer"
                    >
                        Submit
                    </button>
                </form>
