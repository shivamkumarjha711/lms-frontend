...
function Addlecture() {
    const courseDetails = useLocation().state;   // useLocation se hum jis page se navigate ho kar is page me aate hai waha se navigate se data pass kar sakte hai
    ...
    return (
        <HomeLayout>
        <div className="flex flex-col text-black gap-10 items-center justify-center min-h-[90vh] mx-16">
            <div className="flex flex-col gap-5 p-2 shadow-[0_0_10px_black] w-96 rounded-lg">
                ...
                >
                    ...
                    <button type="submit" className="btn btn-primary py-1 font-semibold text-center">
                        Add new Lecture
                    </button>
                </form>
            </div>
