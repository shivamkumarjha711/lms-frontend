...
function Signup() {
    ...
    async function createNewAccount(event) {
        ...
        if (!signupData.password.match(/^(?=.*[0-9])(?=.*[!@#$%^&*])[a-zA-Z0-9!@#$%^&*]{6,16}$/)) {
            toast.error("Password should be 6-16 char long & atleast one special char")
            return;
        }
    ...
    return (
        <HomeLayout>
            <div className="flex items-center justify-center h-[90vh]">
                <form noValidate onSubmit={createNewAccount} className="flex flex-col justify-center gap-3 rounded-lg p-4 text-yellow-500 w-96 shadow-[0_0_10px_black]">
